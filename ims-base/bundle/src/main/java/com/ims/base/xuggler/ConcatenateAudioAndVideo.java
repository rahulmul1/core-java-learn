...
public class ConcatenateAudioAndVideo
{
  ...
  public static void main(String[] args)
  {
   /* if (args.length < 3)
	...
	String video1 = "/Users/rahaggar/DevTools/Java-Project-1/joinvideos/1.mp4";
	String video2 = "/Users/rahaggar/DevTools/Java-Project-1/joinvideos/2.mp4";

    File source1 = new File(video1);
    File source2 = new File(video2);
    String dest = "concatVideo.mp4";
    ...
    concatenate(video1, video2, dest);
  }
