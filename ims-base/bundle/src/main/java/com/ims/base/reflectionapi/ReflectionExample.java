package com.ims.base.reflectionapi;
...
public class ReflectionExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/**
			 * Object can be created from class object newinstance() methods
			 * also. However currently this will give exception coz there is no
			 * no arg constructor present.
			 */
			RentCar rent1 = (RentCar)rental.newInstance();
